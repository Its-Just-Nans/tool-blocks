...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 39, 12, 1286);
    			attr_dev(div, "class", "svelte-k6ktzq");
    			add_location(div, file, 38, 8, 1268);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:4) {#each allMenus as { name }",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file, 50, 4, 1495);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, iframe, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*srcIframe*/ 1 && iframe.src !== (iframe_src_value = /*srcIframe*/ ctx[0])) {
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*srcIframe*/ ctx[0] != "" && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file, 36, 0, 1183);
    		},
